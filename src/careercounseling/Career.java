...
public class Career extends javax.swing.JFrame implements Runnable{
        ...
        public void run()
        {
            try
            {
                ...
                play = Manager.createRealizedPlayer(new File("E:\project\CareerCounseling\src\cs.wav").toURI().toURL());
                play.start();
                for(int i=0;i<=100;i++)
                {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("                 Career Counseling");

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/CareerHome.gif"))); // NOI18N
